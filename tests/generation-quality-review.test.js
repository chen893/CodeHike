    ...
    steps: [
      {
        ...
        focus: { file: 's01_agent_loop.ts', start: 1, end: 1 },
        marks: [{ file: 's01_agent_loop.ts', start: 1, end: 1, color: '#fff' }],
      },
    ],
    ...overrides,
  };
      ...
      steps: [
        {
          ...
          focus: { file: 's01_agent_loop.ts', start: 2, end: 2 },
          marks: [{ file: 's01_agent_loop.ts', start: 2, end: 2, color: '#fff' }],
        },
      ],
    }),
    sourceItems: [
      ...
      steps: [
        {
          ...
          focus: { file: 's01_agent_loop.ts', start: 2, end: 31 },
          marks: [{ file: 's01_agent_loop.ts', start: 2, end: 31, color: '#fff' }],
        },
      ],
    }),
    sourceItems: [
